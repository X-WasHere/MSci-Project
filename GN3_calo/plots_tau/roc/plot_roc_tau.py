...
cjets_rej_benchmark = calculate_rejection(discs_benchmark[is_tau_benchmark].values, discs_benchmark[is_c_benchmark].values, sig_eff)
bjets_rej_benchmark = calculate_rejection(discs_benchmark[is_tau_benchmark].values, discs_benchmark[is_b_benchmark].values, sig_eff)
light_jets_rej_benchmark = calculate_rejection(discs_benchmark[is_tau_benchmark].values, discs_benchmark[is_light_benchmark].values, sig_eff)
# rejection for GN3 with calo data
cjets_rej = calculate_rejection(discs_calo[is_tau].values, discs_calo[is_c].values, sig_eff)
bjets_rej = calculate_rejection(discs_calo[is_tau].values, discs_calo[is_b].values, sig_eff)
light_jets_rej = calculate_rejection(discs_calo[is_tau].values, discs_calo[is_light].values, sig_eff)
...
plot_roc.set_ratio_class(3, Flavours["bjets"])


plot_roc.draw()
plot_roc.savefig("/home/xzcapfed/MSci/GN3_calo/plots_tau/roc/final/roc_ttbar_calo.png", transparent=False)
