...
def load_df(filepath, model_name, num_jets=None, batch_size=500_000, additional_var=None):
    ...
    cuts = Cuts.from_list([
        ("ptFromTruthDressedWZJet", ">", 20000),
        ("HadronGhostTruthLabelID", "==", 5),
        ("eta", "<", 2.5),
        ("eta", ">", -2.5),
    ])


    jet_vars = ["pt", "eta", "HadronGhostTruthLabelID", "ptFromTruthDressedWZJet", f"{model_name}_ptFromTruthDressedWZJet", "ptFinalCalibFromTauJet"]
    if additional_var:
...
if __name__ == "__main__":
    ...
    fname_ttbar='/home/xzcapfed/MSci/GN3_calo/logs/new-data-benchmark/ckpts/epoch=004-val_loss=0.97334__test_ttbar.h5'
    fname_zprime='/home/xzcapfed/MSci/GN3_calo/logs/new-data-benchmark/ckpts/epoch=004-val_loss=0.97334__test_zprime.h5'
    fname_benchmark_ttbar='/home/xzcapfed/MSci/GN3_calo/logs/benchmark/ckpts/epoch=003-val_loss=0.99337__test_ttbar.h5'
    fname_benchmark_zprime='/home/xzcapfed/MSci/GN3_calo/logs/benchmark/ckpts/epoch=003-val_loss=0.99337__test_zprime.h5'
    model_name = "GN3_calo"
    ...
    df['GN3_calo_benchmark_ptFromTruthDressedWZJet'] = df_benchmark['GN3_calo_benchmark_ptFromTruthDressedWZJet']
    df_ttbar['GN3_calo_benchmark_ptFromTruthDressedWZJet'] = df_benchmark_ttbar['GN3_calo_benchmark_ptFromTruthDressedWZJet']
    df_zprime['GN3_calo_benchmark_ptFromTruthDressedWZJet'] = df_benchmark_zprime['GN3_calo_benchmark_ptFromTruthDressedWZJet']
    ...
    plot_path = "/home/xzcapfed/MSci/GN3_calo/plots/regression/final/ttbar/"
    plot_median_sigma_profile(
        df_zprime,
        "ptFromTruthDressedWZJet", # TRUTH 
        "pt", # NOMINAL CALIBRATION 
        # "ptFinalCalibFromTauJet", # GNTau CALIBRATION
        zprime_bins,
        "$p_{T}^{truth}$",
        plot_path,
