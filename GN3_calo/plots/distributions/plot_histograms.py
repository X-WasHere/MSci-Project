...
# load variables
longitudinal_ttbar = filtered_calo_feature(calo_3d, 0, is_ttbar)
longitudinal_zprime = filtered_calo_feature(calo_3d, 0, is_zprime)


lateral_ttbar = filtered_calo_feature(calo_3d, 1, is_ttbar)
lateral_zprime = filtered_calo_feature(calo_3d, 1, is_zprime)


rawEta_ttbar = filtered_calo_feature(calo_3d, 2, is_ttbar)
rawEta_zprime = filtered_calo_feature(calo_3d, 2, is_zprime)

rawPhi_ttbar = filtered_calo_feature(calo_3d, 3, is_ttbar)
rawPhi_zprime = filtered_calo_feature(calo_3d, 3, is_zprime)
...
plt.hist(rawEta_ttbar, bins=30, density=True, histtype='step',color='C0', linewidth=2, linestyle='-')
plt.hist(rawEta_zprime, bins=30, density=True, histtype='step',color='C1', linewidth=2, linestyle='-')
plt.plot([], [], color='C0', label=r'$t\bar{t}$')
plt.plot([], [], color='C1', label=r"$Z'$")
...
plt.figsize=(8, 6)
plt.draw()
plt.savefig(savedir+"rawEta", dpi=300)
plt.close()

plt.hist(rawPhi_ttbar, bins=30, density=True, histtype='step',color='C0', linewidth=2, linestyle='-')
plt.hist(rawPhi_zprime, bins=30, density=True, histtype='step',color='C1', linewidth=2, linestyle='-')
plt.plot([], [], color='C0', label=r'$t\bar{t}$')
plt.plot([], [], color='C1', label=r"$Z'$")
plt.gca().xaxis.set_minor_locator(AutoMinorLocator())
plt.gca().yaxis.set_minor_locator(AutoMinorLocator())
...
plt.figsize=(8, 6)
plt.draw()
plt.savefig(savedir+"rawPhi", dpi=300)
plt.close()

exit()
plt.hist(longitudinal_ttbar, bins=30, density=True, histtype='step',color='C0', linewidth=2, linestyle='-')
plt.hist(longitudinal_zprime, bins=30, density=True, histtype='step',color='C1', linewidth=2, linestyle='-')
plt.plot([], [], color='C0', label=r'$t\bar{t}$')
plt.plot([], [], color='C1', label=r"$Z'$")
plt.gca().xaxis.set_minor_locator(AutoMinorLocator())
plt.gca().yaxis.set_minor_locator(AutoMinorLocator())
...
plt.tick_params(which='minor', length=3, direction='in')
plt.tick_params(which='major', length=7, direction='in')
plt.xlabel('Normalised second longitudinal moment', fontsize=12, loc='right')
plt.ylabel('Normalised Number of Jet Objects', fontsize=12, loc='top')
plt.legend(loc='upper right', frameon=False)
ymin, ymax = plt.ylim()
plt.ylim(ymin, ymax * 1.15)
...
plt.figsize=(8, 6)
plt.draw()
plt.savefig(savedir+"longitudinal", dpi=300)
plt.close()

plt.hist(lateral_ttbar, bins=30, density=True, histtype='step',color='C0', linewidth=2, linestyle='-')
plt.hist(lateral_zprime, bins=30, density=True, histtype='step',color='C1', linewidth=2, linestyle='-')
plt.plot([], [], color='C0', label=r'$t\bar{t}$')
plt.plot([], [], color='C1', label=r"$Z'$")
plt.gca().xaxis.set_minor_locator(AutoMinorLocator())
plt.gca().yaxis.set_minor_locator(AutoMinorLocator())
...
plt.tick_params(which='minor', length=3, direction='in')
plt.tick_params(which='major', length=7, direction='in')
plt.xlabel('Normalised second lateral moment', fontsize=12, loc='right')
plt.ylabel('Normalised Number of Jet Objects', fontsize=12, loc='top')
plt.legend(loc='upper right', frameon=False)
ymin, ymax = plt.ylim()
plt.ylim(ymin, ymax * 1.15)
...
plt.figsize=(8, 6)
plt.draw()
plt.savefig(savedir+"lateral", dpi=300)
plt.close()